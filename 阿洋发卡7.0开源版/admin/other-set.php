	...
	<div class="form-group">
		...
		<div class="col-lg-8">
			<select class="form-control" id="view" name="view">
				<option value="chiji" <?php if($conf['view']=="chiji") echo "selected"; ?> >吃鸡模板 </option>
				<option value="default" <?php if($conf['view']=="default") echo "selected"; ?> >默认模板 </option>
				<option value="ocean" <?php if($conf['view']=="ocean") echo "selected"; ?> >海洋版</option>
